      ...
      <ModalContent>
        ...
        <ModalBody>
          <VStack spacing={4}>
            ...
            <FormControl>
              <FormLabel>Present Year Of Study</FormLabel>
              <Select name="presentYearOfStudy" value={formData.presentYearOfStudy} onChange={handleChange}>
                <option value="">Select</option>
            ...
            <FormControl>
              <FormLabel>Present Year Completed Pursuing</FormLabel>
              <Select name="presentYearCompletedPursuing" value={formData.presentYearCompletedPursuing} onChange={handleChange} >
            ...
            <FormControl>
              <FormLabel>Past Year Of Study</FormLabel>
              <Select name="pastYearOfStudy" value={formData.pastYearOfStudy} onChange={handleChange}>
                <option value="">Select</option>
                <option value="First Year">First Year</option>
                <option value="Second Year">Second Year</option>
                <option value="Third Year">Third Year</option>
            ...
            <FormControl>
              <FormLabel>Past Year Completed Pursuing</FormLabel>
              <Select name="pastYearCompletedPursuing" value={formData.pastYearCompletedPursuing} onChange={handleChange}>
                <option value="">Select</option>
                {/* <option value="Completed">Completed</option>
                <option value="Pursuing">Pursuing</option> */}
                <option value="First Year">First Year Completed</option>
                <option value="Second Year">Second Year Completed</option>
                <option value="Third Year">Third Year Completed</option>
                <option value="Fourth Year">Fourth Year Completed</option>
                <option value="Direct Second Year">Direct Second Year Completed</option>
              </Select>
            </FormControl>
