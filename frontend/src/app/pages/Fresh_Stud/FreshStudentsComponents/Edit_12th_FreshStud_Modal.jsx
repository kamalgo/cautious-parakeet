...
const Edit_12th_FreshStud_Modal = ({ isOpen, onClose, id }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} size="xl">
      <ModalOverlay />
      <ModalContent>
        <ModalHeader>Edit Class 12th Details</ModalHeader>
        <ModalCloseButton />
        <ModalBody>
          <VStack spacing={4}>
          ...
          <FormControl>
              ...
              <Select name="class12Stream" value={formData.class12Stream} onChange={handleChange}>
            ...
            <FormControl>
              <FormLabel>Class 12th State</FormLabel>
              <Select name="class12InstituteState" value={formData.class12InstituteState} onChange={handleChange}>
              <option value="">Select</option>
            ...
            <FormControl>
              ...
              <Select name="class12InstituteDistrict" value={formData.class12InstituteDistrict} onChange={handleChange}>
                <option value="">Select</option>
            ...
            <FormControl>
              <FormLabel>Class 12th Taluka</FormLabel>
              <Select name="class12Taluka" value={formData.class12Taluka} onChange={handleChange}>
                <option value="">Select</option>
            ...
            <FormControl>
              ...
              <Input name="class12CollegeName" value={formData.class12CollegeName} onChange={handleChange}>
              </Input>
            </FormControl>

            <FormControl>
              <FormLabel>Class 12th Course</FormLabel>
              <Input name="class12Course" value={formData.class12Course} onChange={handleChange}>
              </Input>
            </FormControl>
            
            <FormControl>
              <FormLabel>class 12th Board</FormLabel>
              <Select name="class12Board" value={formData.class12Board} onChange={handleChange}>
              <option value="">Select</option>
            ...
            <FormControl>
              ...
              <Input name="class12SeatNumber" value={formData.class12SeatNumber} onChange={handleChange}>
              </Input>
            </FormControl>

            <FormControl>
              <FormLabel>Class 12th Mode</FormLabel>
              <Select name="class12Mode" value={formData.class12Mode} onChange={handleChange}>
              <option value="">Select</option>
            ...
            <FormControl>
              ...
              <Select name="class12AdmissionYear" value={formData.class12AdmissionYear} onChange={handleChange}>
              <option value="">Select</option>
            ...
            <FormControl>
              ...
              <Select name="class12PassingYear" value={formData.class12PassingYear} onChange={handleChange}>
              <option value="">Select</option>
              <option value="2014">2014</option>
              <option value="2015">2015</option>
              <option value="2016">2016</option>
            ...
            <FormControl>
              ...
              <Select name="class12Result" value={formData.class12Result} onChange={handleChange}>
              <option value="">Select</option>
            ...
            <FormControl>
              ...
              <Input name="class12Percentage" value={formData.class12Percentage} onChange={handleChange}>
              </Input>
            </FormControl>

            <FormControl>
              <FormLabel>Class 12th Attempt</FormLabel>
              <Input name="class12Attempts" value={formData.class12Attempts} onChange={handleChange}>
              </Input>
            </FormControl>
...
export default Edit_12th_FreshStud_Modal;
