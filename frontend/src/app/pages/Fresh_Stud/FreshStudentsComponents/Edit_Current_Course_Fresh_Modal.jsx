...
const Edit_Current_Course_Fresh_Modal = ({ isOpen, onClose, id }) => {
        ...
        <ModalBody>
          <VStack spacing={4}>
            ...
            <FormControl>
              ...
              <Input name="cetPercentage" value={formData.cetPercentage} onChange={handleChange}>
              </Input>
            </FormControl>
            ...
            <FormControl>
              <FormLabel>Present Year Completed or Pursuing</FormLabel>
              <Input name="isCompletedPursuing" value={formData.isCompletedPursuing} onChange={handleChange}>
              </Input>
            </FormControl>
            ...
            <FormControl mt={4}>
            <FormLabel>Admission Date of current course</FormLabel>
            <Input type="date" name="admissionDate" value={formData.admissionDate} onChange={handleChange} />
          </FormControl>

          <FormControl>
              <FormLabel>Fees Paid</FormLabel>
              <Input name="feesPaid" value={formData.feesPaid} onChange={handleChange}>
              </Input>
            </FormControl>  
          
            <FormControl>
              <FormLabel>Admission Category</FormLabel>
              <Select name="admissionCategory" value={formData.admissionCategory} onChange={handleChange}>
                <option value="">Select</option>
            ...
            <FormControl>
              ...
              <Select name="modeStudy" value={formData.modeStudy} onChange={handleChange}>
                <option value="">Select</option>
...
export default Edit_Current_Course_Fresh_Modal;